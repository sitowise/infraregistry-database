...
-- How to create ogc api collection
-- SELECT create_ogc_api_collection('ConnectionString', ARRAY['http://www.opengis.net/def/crs/OGC/1.3/CRS84', 'http://www.opengis.net/def/crs/EPSG/0/3067']);
